...
class Settings:
    def __init__(self):
        ...
        self.TELEGRAM_ALERT_RETRY_MAX_ATTEMPTS = _get_int_setting("TELEGRAM_ALERT_RETRY_MAX_ATTEMPTS", 3)
        self.TELEGRAM_ALERT_RETRY_BASE_DELAY_SECONDS = _get_float_setting("TELEGRAM_ALERT_RETRY_BASE_DELAY_SECONDS", 5.0)
        self.TELEGRAM_ALERT_RETRY_QUEUE_MAX_SIZE = _get_int_setting("TELEGRAM_ALERT_RETRY_QUEUE_MAX_SIZE", 1000)
