...
class Settings:
    ...
    def __init__(self):
        ...
        self.TELEGRAM_ALERTS_POLL_SECONDS = _get_float_setting("TELEGRAM_ALERTS_POLL_SECONDS", 0.2)
        self.FANOUT_TARGET_CACHE_TTL_SECONDS = _get_float_setting("FANOUT_TARGET_CACHE_TTL_SECONDS", 2.0)
        self.TELEGRAM_DELIVERY_RETRY_SECONDS = _get_float_setting("TELEGRAM_DELIVERY_RETRY_SECONDS", 15.0)
        self.TELEGRAM_DELIVERY_MAX_ATTEMPTS = _get_int_setting("TELEGRAM_DELIVERY_MAX_ATTEMPTS", 3)
